        ...
        <Card className="w-full max-w-md shadow-2xl border-0 overflow-hidden animate-scale-in">
          ...
          <CardHeader className="text-center pt-8">
            <div className="flex justify-center mb-4">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-green-500/10 animate-pulse-soft">
                <CheckCircle2 className="h-8 w-8 text-green-500" />
              </div>
            </div>
            <CardTitle className="text-2xl font-bold text-foreground">Password Berhasil Diubah</CardTitle>
          ...
          <CardContent className="text-center pb-8">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Mengalihkan ke halaman login dalam beberapa detik...
            </p>
      ...
      <div className="w-full max-w-md animate-scale-in">
        <Card className="shadow-2xl border-0 overflow-hidden">
          ...
          <CardHeader className="text-center pt-8 pb-4">
            ...
            <CardTitle className="text-2xl font-bold text-foreground">Ubah Password</CardTitle>
          ...
          <CardContent className="pb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2 animate-fade-in animate-delay-100">
                <Label htmlFor="password" className="text-foreground font-medium">Password Baru</Label>
                <Input
                  id="password"
                  type="password"
